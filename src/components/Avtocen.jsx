            ...
            <SwiperSlide key={index}>
              ...
              <div className="flex justify-center  flex-wrap 2xl:h-[806px]  h-[709px] gap-[30px]  2xl:pt-[50px]  p-[10px]">
                ...
                {productGroup.map((product) => (
                  ...
                  >
                    <img className="  w-[363px] h-[271px]   2xl:w-[363px]  2xl:h-[237px] rounded-[12px]"
                    ...
                    <h1 className="text-[18px]   2xl:text-[24px] font-bold  pt-[24px]">{product.marc}</h1>
                     ...
                     <h1 className="flex items-center  justify-between w-full max-w-full  pt-[10px] ">  <span className ="whitespace-nowrap text-[16px] font-normal text-[rgb(163,164,165)]" >Пробег</span><img src="/img/Vector 8.png" alt="Line"  className="pt-[15px]  w-[220px]   px-2"/> <span className="whitespace-nowrap text-[20px] font-semibold">{product.probeg}  км</span></h1>
                     <h1 className="flex items-center  justify-between w-full max-w-full pt-[10px]">  <span className ="whitespace-nowrap text-[16px] font-normal text-[rgb(163,164,165)]" >Объем двигателя</span><img src="/img/Vector 8.png" alt="Line"  className="pt-[15px] px-2    w-[200px] "/> <span className="whitespace-nowrap text-[20px] font-semibold">{product.dviga}</span></h1>
                      <h1 className="flex items-center  justify-between w-full max-w-full pt-[10px]">  <span className ="whitespace-nowrap text-[16px] font-normal text-[rgb(163,164,165)]" >Мощность</span><img src="/img/Vector 8.png" alt="Line"  className="pt-[15px] px-2  w-[210px] "/> <span className="whitespace-nowrap text-[20px] font-semibold">{product.mouy}л.с.</span></h1>
                      <h1 className="flex items-center   justify-between w-full max-w-full pt-[10px]">  <span className ="whitespace-nowrap text-[16px] font-normal text-[rgb(163,164,165)]" >Коробка</span><img src="/img/Vector 8.png" alt="Line"  className="pt-[15px] px-2    w-[210px] "/> <span className="whitespace-nowrap text-[20px] font-semibold">{product.cor}</span></h1>
            ...
            <div>
              <h1 className="text-[44px] text-[rgb(192,192,192)] mx-[33px] mt-[-160px]  font-bold">VS</h1>
                ...
                {productGroup.map((product) => (
                  ...
                  >
                    <img className="  w-[363px] h-[240px]   2xl:w-[363px]  2xl:h-[240px] xl:h-[200px]  rounded-[12px]"
                      src={`https://fourfeef.onrender.com/avto${product.img}`}
                      alt={product.name}
                    />
                    <h1 className="text-[18px]   2xl:text-[24px] font-bold  pt-[10px]">{product.marc}</h1>
                      ...
                      <h1 className="flex items-center  justify-between w-full max-w-full pt-[10px]">  <span className ="whitespace-nowrap text-[16px] font-normal text-[rgb(163,164,165)]" >Мощность</span><img src="/img/Vector 8.png" alt="Line"  className="pt-[15px] px-2 w-[112px]  2xl:w-[210px] "/> <span className="whitespace-nowrap text-[20px] text-[rgba(0,0,0,0.66)] font-semibold">{product.mouy}л.с.</span></h1>
                      <h1 className="flex items-center   justify-between w-full max-w-full pt-[10px]">  <span className ="whitespace-nowrap text-[16px] font-normal text-[rgb(163,164,165)]" >Коробка</span><img src="/img/Vector 8.png" alt="Line"  className="pt-[15px] px-2   w-[113px] 2xl:w-[210px] "/> <span className="whitespace-nowrap text-[20px]  text-[rgba(0,0,0,0.66)] font-semibold">{product.cor}</span></h1>
            ...
            <SwiperSlide key={index}>
              ...
              <div className=" flex justify-center flex-wrap   2xl:mt-[0px]  xl:mt-[0px] lg:mt-[50px]  mt-[32px]   md:max-[940px]:mt-[50px] min-[940px]:mt-[50px]    md:max-[940px]:top-[283px] min-[940px]:top-[283px] top-[283px]    pr-[16px]   pl-[16px]    min-[1200px]:pl-[65px]  min-[1200px]:pr-[65px]     h-[1364px] min-[941px]:h-[777px]    gap-[0px]  sm:min-[828px]:gap-[20px] max-[800px]:gap-[13px]   ">
                ...
                {productGroup.map((product) => (
                  ...
                  >
                    <img className="  w-[375px] h-[240px]   2xl:w-[363px]  object-cover  2xl:h-[240px] rounded-[12px]"
                      src={`https://fourfeef.onrender.com/avto${product.img}`}
                      alt={product.name}
                    />
                    <h1 className="text-[18px]   2xl:text-[24px] font-bold  pt-[24px]">{product.marc}</h1>
                     ...
                     <h1 className="flex items-center  justify-between w-full max-w-full pt-[5px]">  <span className ="whitespace-nowrap text-[16px] font-normal text-[rgb(163,164,165)]" >Пробег</span><img src="/img/Vector 8.png" alt="Line"  className="pt-[15px] min-[1920px]:w-[205px]  max-[450px]:w-[43%]  w-[55%]   px-2"/> <span className="whitespace-nowrap text-[20px] font-semibold">{product.probeg}  км</span></h1>
                     <h1 className="flex items-center  justify-between w-full max-w-full pt-[5px]">  <span className ="whitespace-nowrap text-[16px] font-normal text-[rgb(163,164,165)]" >Объем двигателя</span><img src="/img/Vector 8.png" alt="Line"  className="pt-[15px] px-2  min-[1920px]:w-[191px]  max-[450px]:w-[40%]  w-[54%] "/> <span className="whitespace-nowrap text-[20px] font-semibold">{product.dviga}</span></h1>
                     <h1 className="flex items-center  justify-between w-full max-w-full pt-[5px]">  <span className ="whitespace-nowrap text-[16px] font-normal text-[rgb(163,164,165)]" >Мощность</span><img src="/img/Vector 8.png" alt="Line"  className="pt-[15px] px-2  min-[1920px]:w-[200px]  max-[450px]:w-[43%]  w-[53%] "/> <span className="whitespace-nowrap text-[20px] font-semibold">{product.mouy}л.с.</span></h1>
                     <h1 className="flex items-center  justify-between w-full max-w-full pt-[5px]">  <span className ="whitespace-nowrap text-[16px] font-normal text-[rgb(163,164,165)]" >Коробка</span><img src="/img/Vector 8.png" alt="Line"  className="pt-[15px] px-2   min-[1920px]:w-[189px]  max-[450px]:w-[40%]  w-[57%] "/> <span className="whitespace-nowrap text-[20px] font-semibold">{product.cor}</span></h1>
                ...
                {productGroup.map((product) => (
                  ...
                  >
                    <img className="  w-[363px] h-[235px]   2xl:w-[363px]  2xl:h-[237px] rounded-[12px]"
                      src={`https://fourfeef.onrender.com/avto${product.img}`}
                      alt={product.name}
                    />
                    <h1 className="text-[18px]   2xl:text-[24px] font-bold  pt-[24px]">{product.marc}</h1>
                      ...
                      <h1 className="flex items-center  justify-between w-full max-w-full pt-[10px]">  <span className ="whitespace-nowrap text-[16px] font-normal text-[rgb(163,164,165)]" >Мощность</span><img src="/img/Vector 8.png" alt="Line"  className="pt-[15px] px-2  min-[1920px]:w-[200px]  max-[450px]:w-[44%]   w-[56%] "/> <span className="whitespace-nowrap text-[20px] text-[rgba(0,0,0,0.66)] font-semibold">{product.mouy}л.с.</span></h1>
                      <h1 className="flex items-center   justify-between w-full max-w-full pt-[10px]">  <span className ="whitespace-nowrap text-[16px] font-normal text-[rgb(163,164,165)]" >Коробка</span><img src="/img/Vector 8.png" alt="Line"  className="pt-[15px] px-2    min-[1920px]:w-[189px]  max-[450px]:w-[40%]  w-[55%] "/> <span className="whitespace-nowrap text-[20px]  text-[rgba(0,0,0,0.66)] font-semibold">{product.cor}</span></h1>
      ...
      >
        <div className="max-[1920px]:pl-[36px] min-[500px]:pl-[60px] max-[1920px]:pt-[35px] min-[500px]:pt-[52px]">
          ...
          <div className="flex justify-items-center gap-[16px] pt-[26px]">
            <img src="/img/Group.png" className="w-[36px] h-[33px]" />
            <h1>12 подушек безопасности</h1>
          </div>
          <div className="flex justify-items-center gap-[16px] pt-[26px]">
            <img src="/img/free-icon-road-1950853 (1).png" className="w-[36px] h-[29px]" />
            <h1 className="text-[clamp(18px,5vw,20px)]">Удержание в полосе</h1>
          </div>
          <div className="flex justify-items-center gap-[16px] pt-[26px]">
            <img src="/img/_213542088 (1).png" className="w-[36px] h-[29px]" />
